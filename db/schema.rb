...
ActiveRecord::Schema[7.0].define(version: 2023_08_14_113559) do
  ...
  create_table "engines", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "slug"
    t.string "current_seal"
    t.boolean "stolen_status", default: false
  ...
  create_table "service_records", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "engine_id", null: false
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.json "attachments"
